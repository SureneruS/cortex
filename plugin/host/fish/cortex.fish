...
complete -c cortex -n "__fish_seen_subcommand_from checkpoint; and __fish_seen_subcommand_from save" -l stream-ids -r -d "Comma-separated stream IDs (auto-capt..."
...
complete -c cortex -n "__fish_seen_subcommand_from session; and __fish_seen_subcommand_from register" -l id -r -d "Use a specific ID (default: auto-gene..."
...
complete -c cortex -n "__fish_seen_subcommand_from session; and __fish_seen_subcommand_from spawn" -l resume -r -d "CC session UUID to resume (continues ..."
...
complete -c cortex -n "__fish_seen_subcommand_from session; and __fish_seen_subcommand_from spawn" -l below -x -a "(__cortex_session_names)" -d "Split vertically below this session/p..."
complete -c cortex -n "__fish_seen_subcommand_from session; and __fish_seen_subcommand_from spawn" -l color -x -a "blue green yellow purple orange pink cyan red" -d "CC session color (sent via /color aft..."
complete -c cortex -n "__fish_seen_subcommand_from session; and __fish_seen_subcommand_from update" -l data -r -d "JSON object of fields to merge into t..."
